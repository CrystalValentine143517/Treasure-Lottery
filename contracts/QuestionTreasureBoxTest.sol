...
/// @title QuestionTreasureBoxTest
/// @notice Test version without FHE dependencies for unit testing
/// @dev This is a simplified version for testing - production uses FHE encryption
contract QuestionTreasureBoxTest {

    struct Question {
        string questionText;
        uint32 answer;           // Plaintext answer for testing
        uint64 reward;
        bool isActive;
        uint256 createdAt;
    }
    ...
    function answerQuestion(
        ...
        // Verify answer
        bool success = (answer == question.answer);
