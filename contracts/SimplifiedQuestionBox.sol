...
/// @title SimplifiedQuestionBox
/// @notice Answer questions to unlock treasure boxes (without FHE encryption due to Sepolia limitations)
/// @dev Daily limit: 3 attempts per address
contract SimplifiedQuestionBox {

    struct Question {
        string questionText;
        uint32 correctAnswer;  // Plaintext answer (keccak256 hashed for privacy)
        uint64 reward;
        bool isActive;
        uint256 createdAt;
    }
    ...
    function answerQuestion(
        ...
        success = (answer == question.correctAnswer);
